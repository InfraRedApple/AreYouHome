...
class Flash
{
	 ...
	 * @param bool   $autoclose An option to automatically close the alert after a given time, defaults to false
	 *
	 * @return void
	 */
	public static function addMessage($message, $type = 'success', $autoclose = false)
	{
		...
		$_SESSION['flash_notifications'][] = ['body' => $message, 'type' => $type, 'autoclose' => $autoclose ];
	}
